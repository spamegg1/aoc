...
with 0 on the top, then 1, then 2, and so on, all the way through to 10006 on the bottom.
...
below the top card, and so on, until the rightmost card ends up at the bottom of the deck.
...
object Solving:
  import DataDefs.*
  def solve1(lines: Seq[String])(deckSize: Int)(card: Int) = 0L
...
object Test:
  ...
  lazy val res1          = Solving.solve1(lines)(10)(0)
  lazy val res2          = Solving.solve2(lines)(10)(0)
// Test.res1 // part 1: 9 2 5 8 1 4 7 0 3 6
// Test.res2 // part 2:

object Main:
  lazy val lines = os.read.lines(os.pwd / "2019" / "22" / "22.input.txt")
  lazy val res1  = Solving.solve1(lines)(10007)(2019)
  lazy val res2  = Solving.solve2(lines)(10007)(2019)
// Main.res1 // part 1:
// Main.res2 // part 2:
