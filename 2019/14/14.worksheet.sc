...
object Testing:
  ...
  private lazy val lines3 = os.read.lines(os.pwd / "14.test.input.3.txt")
  private lazy val lines4 = os.read.lines(os.pwd / "14.test.input.4.txt")
  private lazy val lines5 = os.read.lines(os.pwd / "14.test.input.5.txt")
...
object Main:
  lazy val lines = os.read.lines(os.pwd / "14.input.txt")
