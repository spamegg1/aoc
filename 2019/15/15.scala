...
Any other command is invalid. The movements differ in direction, but not in distance:
...
object Test:
  private lazy val lines = os.read.lines(os.pwd / "2019" / "15" / "15.test.input.txt")
...
object Main:
  lazy val line = os.read.lines(os.pwd / "2019" / "15" / "15.input.txt").head
