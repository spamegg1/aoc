...
you need to make sure it wasn't corrupted during the download.
...
An orbital transfer lets you move from any object
...
In this example, YOU are in orbit around K,
and SAN is in orbit around I.
To move from K to I,
