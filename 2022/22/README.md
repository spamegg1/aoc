...
drew in their notes. Instead, you are met with a large cube;
...
but the wrapping rules are different.
...
In the above example, if you are at A and move to the right,
...
on each tile you visit, the full path taken by the above example now looks like this:
...
The final password is still calculated from your final position
and facing from the perspective of the map.
