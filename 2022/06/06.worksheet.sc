...
In this case, your subroutine should report the value 7, because the first start-of-packet
 ...
 */
object Solving:
  def solve(size: Int)(line: String) =
    line.sliding(size).indexWhere(_.distinct.size == size) + size
  val solve1 = solve(4)
  val solve2 = solve(14)
