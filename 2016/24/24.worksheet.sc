...
You simply can't reach them. The robot that cleans the air ducts, however, can.
...
object Testing:
  private lazy val lines = os.read.lines(os.pwd / "2016" / "24" / "24.test.input.txt")
...
object Main:
  private lazy val lines = os.read.lines(os.pwd / "2016" / "24" / "24.input.txt")
  lazy val result1 = Solving.solve1(lines)
  lazy val result2 = Solving.solve2(lines)
// Main.result1 // part 1:
// Main.result2 // part 2:
