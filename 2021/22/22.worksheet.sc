...
off by following a list of reboot steps (your puzzle input).
Each step specifies a cuboid (the set of all cubes that have coordinates
...
turns off a 3x3x3 cuboid that overlaps partially with some cubes that are on,
...
positions of at least -50 and at most 50.
