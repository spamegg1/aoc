...
object Test:
  private lazy val lines = os.read.lines(os.pwd / "2018" / "23" / "23.test.input.txt")
...
object Main:
  private lazy val lines = os.read.lines(os.pwd / "2018" / "23" / "23.input.txt")
  lazy val res1          = Solving.solve1(lines)
  lazy val res2          = Solving.solve2(lines)
// Main.res1 // part 1: 319
// Main.res2 // part 2: 129293598
