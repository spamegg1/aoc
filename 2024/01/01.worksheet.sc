...
a group of Senior Historians has asked you to accompany them as
...
so in order to save Christmas, you need to help them get fifty stars
...
has already hit a problem: their list of locations to check is currently empty.
...
of notes and lists of historically significant locations!
...
(your puzzle input), it quickly becomes clear that the lists aren't very similar.
...
In the example list above, the pairs and distances would be as follows:
  The smallest number in the left list is 1, and
...
So, for these example lists, the similarity score at the
...
object Solving:
  ...
  def solve1(lines: Seq[String]) =
    ...
    lefts
      .zip(rights)
      .map((num1, num2) => math.abs(num1 - num2))
      .sum
